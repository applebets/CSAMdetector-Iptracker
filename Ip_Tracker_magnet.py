...
MAGNET_CACHE_PATH = os.path.join(os.path.dirname(__file__), 'last_magnet.txt')
...
if __name__ == "__main__":
    ...
    # ✅ Accept magnet passed as argument (from Jackett GUI)
    if len(sys.argv) > 1:
        magnet_arg = sys.argv[1]
        app.magnet_var.set(magnet_arg)
        app.magnet_entry.config(state="disabled")
        app.start_process()
